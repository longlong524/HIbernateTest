 ...
 * @see org.epiclouds.dao.bean.Post
...
public class PostHome {
	...
	public Post merge(Post detachedInstance) {
		...
		try {
			Post result = (Post) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Post findById(java.lang.Integer id) {
		...
		try {
			Post instance = (Post) sessionFactory.getCurrentSession().get(
					"org.epiclouds.dao.bean.Post", id);
			if (instance == null) {
	...
	public List findByExample(Post instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.epiclouds.dao.bean.Post")
